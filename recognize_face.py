...
while True:
    ...
    # Convert each face location to a tuple (top, right, bottom, left) if needed.
    ...
    # Debug: Uncomment to print the converted face locations.
    # print("Converted face locations:", face_locations)
